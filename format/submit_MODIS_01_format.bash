...
# Wrapper to launch the bash script MODIS_01_format.bash
# This bash script:
# 	
...
if [ $# -ne 5 ]; then
	echo "USAGE:   ./submit_MODIS_01_format.bash YYYYMMi YYYYMMf dataset   overwrite submission_type"
	echo "EXAMPLE: ./submit_MODIS_01_format.bash 201401  201412  MOD06_L2  false     scheduler"
	echo "EXAMPLE: ./submit_MODIS_01_format.bash 201401  201512  MYD06_L2  true      interactive"
	echo "Exit"
	exit
fi
...
#                            Script submission                            #
###########################################################################
script=$working_directory/main_MODIS_01_format.bash
...
while [ $YYYYMM -le $YYYYMMf ]; do
	...
	if [[ $submission_type == scheduler ]]; then
		soumet $script -args $args -jn MODIS_format_${dataset}_$YYYYMM #-t 111600
